<template>
  <div class="tech-card stat-card">
    <div class="card-title">百合生活网年交易笔数（笔）</div>
...
import { lilyLifeYearlyTransactions } from '../../mockData/wangjinData'
import BarChart from '../common/BarChart.vue'

const data = lilyLifeYearlyTransactions

const chartData = computed(() => ({
  xAxis: ['25-06', '25-07', '25-08', '25-09', '25-10', '25-11', '25-12', '26-01', '26-02', '26-03', '26-04', '26-05'],
  series: [{
    name: '交易笔数',
    data: [6500000, 6800000, 7200000, 7000000, 7400000, 7800000, 7600000, 7900000, 8100000, 8200000, 8400000, 8563200]
  }]
}))
