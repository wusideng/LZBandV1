<template>
  <div class="tech-card stat-card">
    <div class="card-title">快捷支付年交易金额（万元）</div>
...
import { quickPayYearlyAmount } from '../../mockData/wangjinData'
import BarChart from '../common/BarChart.vue'

const data = quickPayYearlyAmount

const chartData = computed(() => ({
  xAxis: ['25-06', '25-07', '25-08', '25-09', '25-10', '25-11', '25-12', '26-01', '26-02', '26-03', '26-04', '26-05'],
  series: [{
    name: '交易金额',
    data: [68000, 71000, 74000, 72000, 75000, 76000, 75500, 77000, 78000, 79000, 80000, 89256]
  }]
}))
