<template>
  <div class="tech-card stat-card">
    <div class="card-title">手机银行年交易笔数（笔）</div>
...
import { mobileBankYearlyTransactions } from '../../mockData/wangjinData'
import BarChart from '../common/BarChart.vue'

const data = mobileBankYearlyTransactions

const chartData = computed(() => ({
  xAxis: ['25-06', '25-07', '25-08', '25-09', '25-10', '25-11', '25-12', '26-01', '26-02', '26-03', '26-04', '26-05'],
  series: [{
    name: '交易笔数',
    data: [45000000, 46500000, 48000000, 47000000, 48500000, 49500000, 49000000, 50000000, 51000000, 52000000, 53000000, 56823560]
  }]
}))
