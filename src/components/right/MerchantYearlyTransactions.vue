<template>
  <div class="tech-card stat-card">
    <div class="card-title">特约商户年交易笔数（笔）</div>
...
import { merchantYearlyTransactions } from '../../mockData/wangjinData'
import BarChart from '../common/BarChart.vue'

const data = merchantYearlyTransactions

const chartData = computed(() => ({
  xAxis: ['25-06', '25-07', '25-08', '25-09', '25-10', '25-11', '25-12', '26-01', '26-02', '26-03', '26-04', '26-05'],
  series: [{
    name: '交易笔数',
    data: [2800000, 2900000, 3050000, 2950000, 3100000, 3200000, 3150000, 3250000, 3350000, 3450000, 3550000, 3586200]
  }]
}))
